...
extern "C" void display()
{
  ...
  glUniform2f(posLoc, 0, 0);             // Location for first triangle
  glDrawArrays(GL_TRIANGLES, 0, 3);      // draw the triangles
  glUniform2f(posLoc, -100, -200);       // Location for second triangle
  glDrawArrays(GL_TRIANGLES, 0, 3);      // draw the triangles
  glUniform2f(posLoc, 100, 400);         // Location for third triangle
  glDrawArrays(GL_TRIANGLES, 0, 3);      // draw the triangles
