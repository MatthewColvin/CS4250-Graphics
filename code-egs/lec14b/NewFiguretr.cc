// Example with a robot person
// Initially from Angel's book code
// Major edits by Prog. David M. Chelberg
// Added perspective camera
// Added continuous rotations
// Added some comments
// Fixed bug in initNodes, missing one translate for head.
// 
// last-modified: Sun Oct 29 19:44:56 2017
//
// Still very poor coding style.
//
#include "Angel.h"
#include <assert.h>
