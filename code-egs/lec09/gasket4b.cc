...
//
// This one alters the shaders to get a different effect, it does not
// set colors in the program, rather in the vertex shader.
// 
// Modified by David M. Chelberg
// Added comments
// last-modified: Tue Sep 18 13:52:21 2012
